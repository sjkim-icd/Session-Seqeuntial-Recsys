...
dataBefore = '/content/drive/MyDrive/커리어/추천알고리즘_스터디/[2023 하반기]추천알고리즘 스터디/code/data/yoochoose-data/kaggle/yoochoose-clicks.dat' #Path to Original Training Dataset "Clicks" File
dataTestBefore = '/content/drive/MyDrive/커리어/추천알고리즘_스터디/[2023 하반기]추천알고리즘 스터디/code/data/yoochoose-data/kaggle/yoochoose-test.dat' #Path to Original Testing Dataset "Clicks" File
dataAfter ='/content/drive/MyDrive/커리어/추천알고리즘_스터디/[2023 하반기]추천알고리즘 스터디/code/GRU4Rec/GRU4REC-pytorch-master/GRU4REC-pytorch-master/RecSys_Dataset_After/' #Path to Processed Dataset Folder
